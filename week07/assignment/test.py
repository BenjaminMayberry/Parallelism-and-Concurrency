...
def task_upper(text):
    ...
    """
    text.upper()
    return result_upper.append(f"uppercase version of {text}")
...
def main():
    ...
    for filename in task_files:
        ...
        if task_type == TYPE_PRIME:
            ...
            text_pool.apply_async(task_upper, args = (task['text'], ))
        elif task_type == TYPE_SUM:
            sum_pool.apply_async(task_sum, args = (task['start'], task['end']))
        elif task_type == TYPE_NAME:
            name_pool.apply_async(task_name, args = (task['url'], ))
        else:
