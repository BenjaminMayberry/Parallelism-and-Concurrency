...
def run():
    ...
    if not os.path.exists('C:\\Users\\12088\\Desktop\\cse251-course-master\\week02\\assignment\\data.txt'):
        print('Error the file "data.txt" not found')
        return

    # load dict
    with open('C:\\Users\\12088\\Desktop\\cse251-course-master\\week02\\assignment\\data.txt') as f:
        data = f.read()
