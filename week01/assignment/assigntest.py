...
def draw_squares_thead(tur, lock):
...
def draw_circles_thead(tur, lock):
...
def draw_triangles_thead(tur, lock):
...
def draw_rectangles_thead(tur, lock):
...
def run_with_threads(tur, log, main_turtle):
    ...
    s = threading.Thread(target=draw_squares_thead, args=(tur, lock))
    c = threading.Thread(target=draw_circles_thead, args=(tur,lock))
    t = threading.Thread(target=draw_triangles_thead, args=(tur,lock))
    r = threading.Thread(target=draw_rectangles_thead, args=(tur,lock))
